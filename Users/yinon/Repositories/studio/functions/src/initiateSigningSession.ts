...
import { FieldValue } from 'firebase-admin/firestore'; // Correctly import FieldValue
  ...
  async (request) => {
    ...
    try {
      ...
      await contractRef.update({
          ...
          status: 'pending',
          lastUpdatedAt: FieldValue.serverTimestamp(), // Use the directly imported FieldValue
      });
