    ...
    if (error.code) {
      ...
      switch (error.code) {
        ...
        case 'auth/popup-blocked':
          description =
            'חלון הכניסה של גוגל נחסם על ידי הדפדפן. אנא אפשר חלונות קופצים עבור אתר זה.';
          break;
        ...
        case 'auth/account-exists-with-different-credential':
          description =
            'קיים כבר חשבון עם אימייל זה אך עם שיטת כניסה אחרת. נסה להתחבר בשיטה האחרת.';
          break;
        ...
        case 'auth/too-many-requests':
          description =
            'נשלחו יותר מדי בקשות אימות למספר זה. נסה שוב מאוחר יותר.';
          break;
        ...
        case 'auth/email-already-in-use':
          description =
            'כתובת האימייל כבר בשימוש. נסה להתחבר או להשתמש באימייל אחר.';
          break;
        ...
        case 'auth/weak-password':
          description =
            'הסיסמה חלשה מדי. אנא בחר סיסמה חזקה יותר (לפחות 6 תווים).';
          break;
        ...
        case 'auth/api-key-not-valid':
          description =
            'מפתח ה-API של Firebase אינו תקין. אנא בדוק את הגדרות הפרויקט.';
          break;
        default:
  ...
  const loginWithEmail = async (email: string, pass: string) => {
    ...
    try {
      ...
      return handleAuthError(
        error,
        'הכניסה נכשלה. בדוק אימייל וסיסמה.',
        'email'
      );
    } finally {
      setIsFirebaseLoading(false);
