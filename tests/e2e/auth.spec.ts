...
test.describe('Authentication Flow', () => {
  test.describe('Login Page', () => {
    ...
    test('should switch between email and phone authentication', async ({ page }) => {
  ...
  test.describe('Protected Routes', () => {
    ...
    test('should redirect to login when accessing contract creation without auth', async ({ page }) => {
