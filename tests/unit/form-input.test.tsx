...
describe("FormInput Component", () => {
  ...
  it("calls onChange handler when user types", async () => {
    ...
    render(<FormInput {...defaultProps} label="שם" onChange={handleChange} />);
  ...
  it("renders with placeholder text", () => {
    render(
      <FormInput {...defaultProps} label="טלפון" placeholder="050-1234567" />
    );
  ...
  it("renders as textarea when type is textarea", () => {
    render(<FormInput {...defaultProps} label="הערות" type="textarea" />);
